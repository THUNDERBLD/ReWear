...
// const registerSaler = asyncHandler( async (req, res) => {
...
// const loginSaler = asyncHandler( async (req, res) => {
...
// const logoutSaler = asyncHandler( async(req, res) => {
...
// const getCurrentSaler = asyncHandler( async (req, res) => {
