...
const ServicesBlocks = (props) => {
  ...
  return (
    <section className="bg-white dark:bg-gray-900 py-16 px-6 rounded-md">
      <div className="max-w-screen-xl mx-auto grid lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
            <div
              className="px-6 py-3 text-black bg-primary-700 hover:bg-primary-800 rounded-lg text-lg font-medium transition-all focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              Get Started
              <svg className="w-5 h-5 ml-2 inline-block" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                <path 
                  fillRule="evenodd" 
