    ...
    return (
        <div className='flex flex-col lg:flex-row my-10 py-8 pb-10 px-4 rounded-md shadow-md bg-white'>
                ...
                <div className="mb-5 mt-3">
                    ...
                    <div className="text-gray-800 py-4 px-4 border rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        ...
                        <div className="mt-2 sm:mt-0">
                            <CopyTextButton copyText="Saras Market, KMVN Complex, Heera Nagar, Haldwani, Uttarakhand 263139" />
                        </div>
                    </div>
                </div>
                <div className="mb-5 mt-3">
                    ...
                    <div className="text-gray-800 py-4 px-4 border rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        <p className="text-sm md:text-base">+91 9359488838</p>
                        <div className="mt-2 sm:mt-0">
                            <CopyTextButton copyText="9359488838" />
                        </div>
                    </div>
                </div>
                <div className="mb-5 mt-3">
                    ...
                    <div className="text-gray-800 py-4 px-4 border rounded-lg flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        <p className="text-sm md:text-base">Ayanalihaider9@gmail.com</p>
                        <div className="mt-2 sm:mt-0">
                            <CopyTextButton copyText="Ayanalihaider9@gmail.com" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-[35vw] px-4 lg:px-10 mt-4">
                <p className="text-gray-600 text-lg md:text-2xl mb-4 lg:mb-8 text-center lg:text-left">Contact Us</p>
